...
- `GET /tenant` and `PATCH /tenant` (TEN-01, chunk 1 brief): explicit columns instead of
  ...
  own; retention is chunk 12's. `change_case.triage_due_at` lands with
  `c10-case-triage-due` (section 20).
...
## 19. Chunk 9's case workflow tables (2026-09-25, c9-case-models)
