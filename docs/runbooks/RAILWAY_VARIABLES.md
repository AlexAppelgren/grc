...
| `SUPPORT_ACCESS_MAX_HOURS` | api | `4` | `4` | `4` | The longest window platform support may ask a bank for, in hours (TEN-06, D-49). The window starts when a bank administrator approves it; a longer request answers 422 |
| `SUPPORT_ACCESS_REQUEST_TTL_HOURS` | api | `24` | `24` | `24` | How long a support access request nobody decides stays open before it lapses, in hours (TEN-06). Read against the clock, with no job |
