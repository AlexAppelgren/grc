...
> design for PRD module **ACC** (ACC-01 to ACC-10), decisions **D-68 to D-73** and
...
1. **Both credential kinds, service key first** (D-69). A service key bound to
   an entry, and a personal access token that acts as a person.
2. **The bank's own register is the payload** (D-68). "The agent can access
