...
**PRD 0.5 (decided 2026-09-20, landed 2026-09-23).** Chunk 11 gains module ACC, the
agents a bank runs itself (`docs/plans/briefs/AGENT_ACCESS.md`, D-70 to D-73, D-76
and D-77, ADRs 0055 to 0057). ACC sits **below** the AGT work in the chunk's list, so
the descope rule cuts it first: it depends on chunk 8's departments, products, teams
and register and on chunk 7's search, and it is the newest requirement in the
release. If it is cut, it moves whole to chunk 13, where ACC-10 already sits, and
