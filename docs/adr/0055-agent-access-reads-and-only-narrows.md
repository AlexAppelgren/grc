...
**Date:** 2026-09-20 · **Status:** accepted (owner decision, 2026-09-20; D-70, D-73, D-76, PRD 0.5 ACC-01, ACC-02, ACC-04, ACC-05, ACC-07)
...
- **It reads, and in R2 it only reads.** Every mutating route answers 403
  ...
  The proposal door, a person's confirmed applicability decision (D-75) and the
  four-eyes constraints stay the only ways anything changes, and none of them is
  reachable from here.
