...
**Date:** 2026-09-20 · **Status:** accepted (owner decision, 2026-09-20; D-72, D-76, amends D-07, PRD 0.5 ACC-04, ACC-08)
...
- Answered by default in `docs/TODO_FOR_alex.md` (Alex, 2026-09-23: "Land the
  design now as decided"), and still his to overrule: a bank running its agent on
  a model endpoint outside the EU is the bank's decision, and the first procurement
  review will ask what we do about it. The build states it plainly in the assurance
  pack, records the approval, and does not police the endpoint.
