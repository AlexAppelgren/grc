...
approveProposal, createConsoleTenant, updateTenant, createFootprintRequest, createChange,
confirmSoWhat, rateAnswer. ADM-S4 also drives the console routes other apps register — the
source registry, the platform agent keys and the agent definitions they bind to — by their
gate alone; what each one then does is its own app's scenario.
