...
Since PRD 0.4 (Alex, 2026-09-20, D-48 and ADR 0042) a library proposal may be
...
### AUD-S8 — An agent's approval is in the audit trail with the agent named `@integration` (AUD-01, AUD-02)
```gherkin
