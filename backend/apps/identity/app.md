...
keys, and no scope reaches the library. PRD 0.4 (D-48, ADR 0042) adds one
...
### ID-S27 — The review scope reaches the queue and never a library row `@integration` (ID-10, AC-PRO1, AC-ID3)
```gherkin
