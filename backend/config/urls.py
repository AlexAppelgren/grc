...
CORS scoping (playbook 2.2). There is no admin URL, on purpose (playbook 4.3). A path that
matches nothing answers in the one problem shape (playbook 4.4), not Django's HTML page."""
