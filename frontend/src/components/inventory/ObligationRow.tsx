...
import { outsideFootprintLabel, presentObligation, type ObligationFacts } from '@/features/library/obligation-presentation';
 ...
 * and, outside the footprint, what puts it there.
 */
