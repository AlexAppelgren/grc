...
// The phone header: the phonetic mark (64px, in the page's text colour) on
...
export function MobileHeader() {
  return (
    <header data-mobile-header="" className="mb-4 flex h-8 items-center justify-between gap-2 md:hidden">
