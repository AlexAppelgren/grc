...
// The participant calls (backend/apps/collab/api.py) and the people and team
...
/** A register entry holds at most 50 participants unless configured otherwise, so one page of the maximum shows them all. */
